...
/**
 * Address controlller for the customer basically for the tasks of customers which will
...
class AddressController extends Controller
{
    ...
    )
    {
        ...
        $this->customer = auth()->guard('customer')->customer();
    ...
    public function store()
    {
        ...
        if ($this->address->create($data)) {
            session()->flash('success', trans('site::app.customer.account.address.create.success'));

            return redirect()->route($this->_config['redirect']);
        } else {
            session()->flash('error', trans('site::app.customer.account.address.create.error'));
    ...
    public function edit($id)
    {
        $address = $this->address->findOneWhere([
            'id' => $id,
            'customer_id' => auth()->guard('customer')->customer()->id
        ]);
    ...
    public function update($id)
    {
        ...
        foreach($addresses as $address) {
            if ($id == $address->id) {
                session()->flash('success', trans('site::app.customer.account.address.edit.success'));
    ...
    public function makeDefault($id)
    {
        ...
        if ($address = $this->address->find($id)) {
            ...
            session()->flash('success', trans('site::app.customer.account.address.index.default-delete'));
        }
    ...
    public function destroy($id)
    {
        ...
        session()->flash('success', trans('site::app.customer.account.address.delete.success'));
